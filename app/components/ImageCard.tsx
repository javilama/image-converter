...
export default function ImageCard({
  ...
  const btnPrimary = `${buttonBase} bg-gradient-to-r from-yellow-500/30 to-orange-500/30 disabled:cursor-not-allowed w-[20%] rounded-s-lg`;
  const btnSuccess = `${buttonBase} bg-gradient-to-r from-green-400/30 to-emerald-500/30 disabled:cursor-not-allowed gap-2`;
  const btnDanger = `${buttonBase} bg-gradient-to-r from-red-500/30 to-rose-500/40 w-[20%] rounded-e-lg`;
